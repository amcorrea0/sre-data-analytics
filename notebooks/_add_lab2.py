"""
Append Labs 2, 3, 4 a build_notebooks.py.
(Se ejecuta una vez para extender el script, luego es idempotente).
"""
...
LAB_2 = notebook([
    md("# Lab 2 - Automatizacion: cada job cuenta su historia\n\n"
       ...
       "a diario (restart_pod, scale_deployment, db_vacuum, etc.). El director nos pregunta:\n\n"
    ...
    py("# Estimacion: horas-hombre perdidas por año por job\n"
...
(NB_DIR / "lab2_automatizacion.ipynb").write_text(__import__('json').dumps(LAB_2, indent=1), encoding="utf-8")
print("wrote lab2")