"""Construye los 4 notebooks (.ipynb) v3.

Cambios vs v2:
- Cada servicio tiene su propia personalidad en los datos.
- Graficos cuentan decisiones ejecutivas concretas.
- Heatmaps nuevos: alertas por dia x hora x servicio.
- Anotaciones en figuras: que decision habilita cada grafica.
"""
...
LAB_1 = notebook([
    md("# Lab 1 - Observabilidad: ETL + outliers + alertas\n\n"
       ...
       "Para responder, necesitamos ver:\n"
       "1. Cual servicio consume mas CPU consistentemente\n"
       "2. Cual tiene picos recurrentes en horarios especificos (alertas operacionales)\n"
       "3. Cual esta saturado permanentemente\n\n"
       "## Entregable\n"
       "3 figuras + 1 tabla con recomendacion de capacidad por servicio."),
    ...
    py("fig, ax = plt.subplots(figsize=(12, 5))\n"
       ...
       "ax.set_yscale('log')\n"
       "ax.set_title('Latencia por servicio (eje log) - puntos arriba del bigote son outliers')\n"
...
write = lambda name, nb: (NB_DIR / name).write_text(json.dumps(nb, indent=1), encoding="utf-8")
print("wrote lab1")
write("lab1_observabilidad.ipynb", LAB_1)